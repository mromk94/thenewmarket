<?php $title = 'Add Deposit Method'; ?>

<section class="hero" style="padding: 2rem 0;">
    <h1>Add Deposit Method</h1>
    <p>Create a crypto or bank option for vendor top-ups.</p>
</section>

<form action="<?= url('/admin/deposit-methods') ?>" method="POST" enctype="multipart/form-data" class="glass-card mt-4" style="padding:1.5rem;">
    <?= csrf_field() ?>
