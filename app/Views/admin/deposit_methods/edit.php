<?php $title = 'Edit Deposit Method'; ?>

<section class="hero" style="padding: 2rem 0;">
    <h1>Edit Deposit Method</h1>
    <p>Update a crypto or bank option for vendor top-ups.</p>
</section>

<form action="<?= url('/admin/deposit-methods/' . $method['id']) ?>" method="POST" enctype="multipart/form-data" class="glass-card mt-4" style="padding:1.5rem;">
    <?= csrf_field() ?>
    ...
    <div class="form-group">
        <label for="instructions">Instructions for vendors</label>
    ...
    <div class="mt-4">
        ...
        <a href="<?= url('/admin/deposit-methods') ?>" class="btn btn-outline">Cancel</a>
    </div>
</form>
