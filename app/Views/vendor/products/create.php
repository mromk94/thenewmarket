<section class="hero" style="padding: 2rem 0;">
    <h1>Add Product</h1>
    <p>Submit a new product for admin review.</p>
</section>
...
<section class="glass-card max-w-lg" style="padding: 1.5rem;">
    <form action="<?= url('/vendor/products') ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" id="short_description" name="short_description" value="<?= e(old('short_description')) ?>">
        </div>
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" id="sku" name="sku" value="<?= e(old('sku')) ?>">
        </div>
        ...
        <div class="mb-3" style="display:flex; gap:1rem;">
            ...
            <div style="flex:1;">
                ...
                <input class="form-control" type="number" id="compare_at_price" name="compare_at_price" step="0.01" min="0" value="<?= e(old('compare_at_price')) ?>">
            </div>
        </div>

        <div class="mb-3">
            <label for="stock_qty" class="form-label">Stock quantity</label>
            <input class="form-control" type="number" id="stock_qty" name="stock_qty" min="0" value="<?= e(old('stock_qty') ?? '0') ?>" required>
        </div>

        <div class="mb-3">
            <label class="form-label" style="display:flex; align-items:center; gap:0.5rem;">
                <input type="checkbox" name="is_affiliate_eligible" value="1" <?= old('is_affiliate_eligible') ? 'checked' : '' ?>>
        ...
        <div class="mb-3" style="display:flex; gap:1rem; align-items:flex-end;">
            <div style="flex:1;">
                ...
                <select class="form-control" id="affiliate_commission_type" name="affiliate_commission_type">
                    <option value="percentage" <?= old('affiliate_commission_type') === 'percentage' ? 'selected' : '' ?>>Percentage</option>
                    <option value="fixed" <?= old('affiliate_commission_type') === 'fixed' ? 'selected' : '' ?>>Fixed amount</option>
                </select>
            </div>
            <div style="flex:1;">
                <label for="affiliate_commission_value" class="form-label">Commission value</label>
                <input class="form-control" type="number" id="affiliate_commission_value" name="affiliate_commission_value" step="0.01" min="0" value="<?= e(old('affiliate_commission_value') ?? '0') ?>">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <p style="color:var(--muted); font-size:0.8rem; margin-top:0.25rem;">JPG, PNG, GIF, WebP. Max 2MB.</p>
        </div>
